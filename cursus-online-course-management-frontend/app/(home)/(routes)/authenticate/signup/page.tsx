...
import { loginWithGoogle, register, signUp } from "@/actions/authentication";
...
const formSchema = z.object({
  ...
  phone: z
    ...
    .regex(/^0\d{9,10}$/, {
      message:
        "Phone number must be a valid Vietnamese number starting with 0 and containing only digits",
    })
    .optional(),
  fullName: z
    .string()
